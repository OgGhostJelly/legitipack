...
scoreboard players set .left_rotation_z walldisplay_reg 2147483647
scoreboard players operation .translation_x walldisplay_reg += .world_size_x walldisplay_reg
scoreboard players operation .translation_y walldisplay_reg += .world_size_y walldisplay_reg
